...
plot(expression.ward, main = "Expression Hierarchical Clustering Dendogram")
...
expression.genes <- order(res$padj, decreasing = FALSE)[1:20]
```
...
expression.genes.cleaned <- sapply(strsplit(rownames(counts.df[expression.genes,]), 
                                      "\\."), "[", 1)
...
# Create a data frame called survival with a vector that contains TRUE = dead and 
# FALSE = alive
